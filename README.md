...
Status: The project contains a tokenizer with a small corpus of ca. 300 sentences and a vocabulary of 204. It is currently a research project and not ready for public use.
...
Further development: The next stage of the project includes expanding the corpus and creating a tiny LLM. The tiny LLM will then be trained on the corpus. As the project progresses, my aim is to release small demos and seek collaboration with members of the Manx-speaking community. A full, open-source pipeline is planned. 
